...
class DynamicTypesAdaptiveUIViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        descriptionLabel.text = NSLocalizedString("It looks like we lost you there for a second. Please check your connection and try again", comment: "")
        callToActionButton.setTitle(NSLocalizedString("Retry", comment: ""), for: .normal)
