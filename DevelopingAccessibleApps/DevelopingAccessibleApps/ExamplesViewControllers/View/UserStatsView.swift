...
class UserStatsView: UIStackView {
    ...
    override var accessibilityElements: [Any]? {
        ...
        get {
            ...
            followersAccessibilityElement.accessibilityLabel = "\(followersHeadingLabel.accessibilityLabel!), \(followersNumberLabel.accessibilityLabel!)"
            followersAccessibilityElement.accessibilityFrameInContainerSpace = followersStackView.convert(followersHeadingLabel.frame, to: self).union(followersStackView.convert(followersNumberLabel.frame, to: self))
